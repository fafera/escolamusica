        ...
        <div class="col-lg-10">
            <div class="card">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    <input type="hidden" data-url="{{ url('/professores/get/json')}}" id="json_url">
                                    <label class="form-control-label" for="id_professor">Selecione o professor:</label>
                ...
                <div class="card-body" style="max-height: 1000px; overflow-y: scroll;" id="lista-aulas">
                    @component('components.aulas.lista-aulas',['professor' => $professores->first(), 'mes' => date('m'), 'ano' => date('Y')])
        ...
        <div class="col-lg-2">
            <div class="card">
                ...
                <div id="lista-alunos" class="card-body list-card">
                    @component('components.aulas.lista-alunos', ['professor' => $professores->first(), 'mes' => date('m'), 'ano' => date('Y')])
