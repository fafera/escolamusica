<div class="row">
    <div class="col-md-12">
        @if(!is_null($mensalidade->pagamentos->first()))
        ...
        @if($mensalidade->status != 'pago')
            ...
            <form id="form-pagamento" method="POST" action="{{ route('pagamentos.store') }}">
                @csrf
                <input type="hidden" name="tipo" value="mensalidade">
                <input type="hidden" name="id_referencia" value="{{$mensalidade->id}}">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-lg-11">
                        <input id="valor" min="1" name="valor" class="value-field form-control" type="text" value="{{$mensalidade->valorRestante}}">
                    </div>
                </div>
