<div class="modal fade" name="modal-edit-aula-teste" id="aula-teste-modal-edit-{{ $aula->id }}" tabindex="-1"
    role="dialog" aria-labelledby="EditarAula" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body mx-3">
                <form action="{{ route('aulas.update', $aula->id) }}" method="PUT"
                    id="form-modal-edit-aula-teste-{{ $aula->id }}">
                    @csrf
                    ...
                    <div class="md-form form-group mb-2">
                        ...
                        <input type="text" name="tipo" readonly="readonly" class="form-control"
                            value="{{ $aula->tipo }}">
                    </div>
                    <div class="md-form form-group mb-2">
                    ...
                    <div class="md-form form-group mb-5 ckeditor-content">
                        ...
                        <textarea class="form-control" name="descricao" id="descricao_aula_teste{{ $aula->id }}"
                            cols="30" rows="10">{!! $aula->descricao !!}</textarea>
            ...
            <div class="modal-footer d-flex justify-content-center">
                ...
                <button name="delete-aula-teste" id="delete-aula-{{ $aula->id }}"
                    data-url="{{ route('aulas.destroy', $aula->id) }}"
                    class="btn btn-danger btn-delete-aula">Deletar</button>
            </div>
        </div>
    </div>
</div>
